...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  ...
  return (
    <th
      ...
      className={cn(
        `${isHeader ? "text-white" : "text-foreground"} h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]`,
        className,
      )}
      {...props}
    />
