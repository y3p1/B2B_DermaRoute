...
export default function AdminSignupStep4Success() {
  return (
        ...
        <div className="flex-1 rounded-lg flex flex-col justify-center overflow-hidden min-h-175">
          ...
          <div className="mb-12">
            <p className="text-xl text-black text-center">
              The new admin can now sign in with OTP using their phone number.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            >
              <Link href="/admin/users/new">Create another</Link>
            </Button>
            <Button
              asChild
