...
import type { ClinicStaffProfileForm } from "./ClinicStaffSignupStep1Profile";

const steps = ["Profile", "Verification", "Summary"];

export interface ClinicStaffSignupStep3SummaryProps {
  profile: ClinicStaffProfileForm;
  onNext: () => void;
  onBack: () => void;
...
export default function ClinicStaffSignupStep3Summary({
  profile,
  onNext,
  onBack,
  isSubmitting,
  error,
  onDismissError,
}: ClinicStaffSignupStep3SummaryProps) {
  return (
