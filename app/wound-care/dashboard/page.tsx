...
import { Plus, Bandage } from "lucide-react";
...
export default function WoundCareDashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="mb-8">
        <DashboardStatsRow total={orders.length} counts={counts} loading={loading} totalLabel="Total BVs" totalIconClassName="bg-emerald-50 text-emerald-600" totalValueClassName="text-emerald-900" />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-emerald-600 rounded-xl p-6 text-white flex flex-col justify-between">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 mt-4 px-5 py-2.5 bg-white text-emerald-700 font-semibold rounded-lg hover:bg-emerald-50 active:bg-emerald-100 transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-600"
          >
