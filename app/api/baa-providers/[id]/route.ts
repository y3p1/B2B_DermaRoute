import {
  getBaaProviderAdminController,
  updateBaaProviderAdminController,
} from "../../../../backend/controllers/baaProvidersAdmin.controller";
...
export async function GET(request: Request) {
  return runServerPipeline(request, {
    ...
    handler: (req, res, next) => {
      void getBaaProviderAdminController(req, res)
        .then(() => next())
        .catch(next);
    },
    errorHandler,
...
export async function PATCH(request: Request) {
  return runServerPipeline(request, {
    ...
    handler: (req, res, next) => {
      void updateBaaProviderAdminController(req, res)
        .then(() => next())
        .catch(next);
    },
    errorHandler,
